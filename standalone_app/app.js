...
const translations = {
    fr: {
        ...
        cancel: 'Annuler',
        save: 'Enregistrer',
        reloadData: 'Recharger depuis data.js',
        saveDataJs: 'Sauvegarder data.js',
        dataSaved: '✅ Fichier data.js sauvegardé avec succès !',
        errorSaveData: 'Erreur lors de la sauvegarde :',
        unsavedChanges: 'Modifications non sauvegardées',
        allSaved: 'Tout est sauvegardé',
    ...
    en: {
        ...
        cancel: 'Cancel',
        save: 'Save',
        reloadData: 'Reload from data.js',
        saveDataJs: 'Save data.js',
        dataSaved: '✅ File data.js saved successfully!',
        errorSaveData: 'Error saving:',
