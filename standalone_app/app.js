...
const translations = {
    fr: {
        title: 'Gestionnaire de Ports pfSense',
        subtitle: 'Configuration et gestion des règles - V2.0',
        menu: 'Menu',
        lightMode: 'Mode clair',
        darkMode: 'Mode sombre',
        actions: 'ACTIONS',
        exports: 'EXPORTS',
        addPort: 'Ajouter Port',
        addDevice: 'Ajouter Périphérique',
        addCategory: 'Ajouter Catégorie',
        exportCSVPorts: 'Export CSV Ports',
        exportPfSense: 'Export pfSense',
        exportDevices: 'Export Parc Informatique',
        portRules: 'Règles de Ports',
        devices: 'Parc Informatique',
        noRules: 'Aucune règle de port',
        noDevices: 'Aucun périphérique',
        clickAddPort: 'Cliquez sur "Ajouter Port" pour commencer',
        clickAddDevice: 'Cliquez sur "Ajouter Périphérique" pour commencer',
        rules: 'règles',
        state: 'État',
        icon: 'Icône',
        service: 'Service',
        ...
        addPortModal: 'Ajouter un Port',
        editPortModal: 'Modifier le Port',
        serviceApp: 'Service/Application *',
        portInternal: 'Port Interne *',
        portExternal: 'Port Externe *',
        protocolLabel: 'Protocole *',
        select: 'Sélectionner...',
        descriptionLabel: 'Description',
        categoryLabel: 'Catégorie *',
        destinationLabel: 'Destination (VM/PC)',
        ipAddress: 'Adresse IP',
        iconUrl: 'URL de l\'icône (optionnel)',
        iconUrlHelp: 'Lien direct vers une image (PNG, JPG, SVG). Si vide, affiche la première lettre.',
        cancel: 'Annuler',
        save: 'Enregistrer',
        reloadData: 'Recharger depuis data.json',
        confirmReloadData: 'Êtes-vous sûr de vouloir recharger les données depuis data.json ? Toutes les modifications non exportées seront perdues.',
        dataReloaded: 'Données rechargées avec succès depuis data.json !',
        errorReloadData: 'Erreur lors du rechargement des données :',
        addDeviceModal: 'Ajouter un Périphérique',
        editDeviceModal: 'Modifier le Périphérique',
        hostnameLabel: 'Hostname *',
        ipMaskLabel: 'Adresse IP/Masque *',
        macLabel: 'Adresse MAC',
        typeLabel: 'Type *',
        addCategoryModal: 'Ajouter une Catégorie',
        categoryName: 'Nom de la catégorie *',
        add: 'Ajouter',
        confirmDeletePort: 'Êtes-vous sûr de vouloir supprimer ce port ?',
        confirmDeleteDevice: 'Êtes-vous sûr de vouloir supprimer ce périphérique ?',
        confirmDeleteCategory: 'Supprimer la catégorie "{0}" et toutes ses règles ?',
        close: 'Fermer',
        footerCopyright: '© tous droits réservés 2025/2026',
        footerCreator: 'une création imaginée par Falcom'
    },
    en: {
        title: 'pfSense Port Manager',
        subtitle: 'Configuration and rules management - V2.0',
        menu: 'Menu',
        ...
        devices: 'Devices',
        noRules: 'No port rules',
        noDevices: 'No devices',
        clickAddPort: 'Click "Add Port" to get started',
        clickAddDevice: 'Click "Add Device" to get started',
        rules: 'rules',
        state: 'State',
        icon: 'Icon',
        service: 'Service',
        ...
        addPortModal: 'Add a Port',
        editPortModal: 'Edit Port',
        serviceApp: 'Service/Application *',
        ...
        iconUrlHelp: 'Direct link to an image (PNG, JPG, SVG). If empty, displays first letter.',
        cancel: 'Cancel',
        save: 'Save',
        reloadData: 'Reload from data.json',
        confirmReloadData: 'Are you sure you want to reload data from data.json? All unexported changes will be lost.',
        dataReloaded: 'Data successfully reloaded from data.json!',
        errorReloadData: 'Error reloading data:',
        addDeviceModal: 'Add a Device',
        editDeviceModal: 'Edit Device',
        hostnameLabel: 'Hostname *',
        ipMaskLabel: 'IP Address/Mask *',
        macLabel: 'MAC Address',
        typeLabel: 'Type *',
        addCategoryModal: 'Add a Category',
        categoryName: 'Category name *',
        add: 'Add',
        confirmDeletePort: 'Are you sure you want to delete this port?',
        confirmDeleteDevice: 'Are you sure you want to delete this device?',
        confirmDeleteCategory: 'Delete category "{0}" and all its rules?',
        close: 'Close',
        footerCopyright: '© all rights reserved 2025/2026',
        footerCreator: 'a creation imagined by Falcom'
    }
};
